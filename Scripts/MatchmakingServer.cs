...
*/
   ...
   /*     NetworkManager.Singleton.GetComponent<UnityTransport>().SetConnectionData("0.0.0.0", _serverPort);
    ...
    IEnumerator GetPublicIP()
    {
        ...
        else
        {
            ...
            Debug.Log("api Your public IP address is: " + www.text);
        }
    }
...
/*                NetworkManager.Singleton.GetComponent<UnityTransport>().SetConnectionData(_externalServerIP, _serverPort,_externalServerIP);
*/             
